	        ...
	        <div class="row justify-content-center">
	            <div class="col-md-10">
	                <div class="card">
						...
						%><tr>
							<td class="tableTh"><%=Category.getId() %></td>
							<td class="tableTh"><%=Category.getName() %></td>
							<td class="tableTh"><%=Category.getDescription() %></td>
							<td class="tableTh"><a class="btn btn-info" href="getCategory?id=<%=Category.getId() %>" >Edit</a></td>
							<td class="tableTh"><Button class="btn btn-warning" id="<%=Category.getId() %>" onclick="clickDelete(this);">Delete</Button></td>
						  </tr>
						<%
							}
						%>
